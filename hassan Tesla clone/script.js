...
function Myfunction() {
    ...
    document.querySelector('header').style.background = `linear-gradient(0deg,rgba(44, 44, 44, 0.363),rgba(44, 44, 44, 0.363)),url('images/background-image.jpg')`
...
function display() {
    ...
    document.querySelector('header').style.background = `url('images/background-image.jpg')`
    document.querySelector('header').style.backgroundSize = 'cover'
    document.querySelector('header').style.backgroundPosition = 'center'
    document.querySelector('body').style.overflowY = 'scroll'
}

$(".model-3 .fa-chevron-down").click(function(){   
$('html,body').animate({
        scrollTop : $('.model-Y').offset().top},
        'slow');
});
$(".model-Y .fa-chevron-down").click(function(){   
    $('html,body').animate({
            scrollTop : $('.model-S').offset().top},
            'slow');
    });
    $(".model-S .fa-chevron-down").click(function(){   
        $('html,body').animate({
                scrollTop : $('.model-X').offset().top},
                'slow');
        });
        $(".model-X .fa-chevron-down").click(function(){   
            $('html,body').animate({
                    scrollTop : $('.Solar-Panels').offset().top},
                    'slow');
            });
            $(".Solar-Panels .fa-chevron-down").click(function(){   
                $('html,body').animate({
                        scrollTop : $('.Solar-Roof').offset().top},
                        'slow');
                });
                $(".Solar-Roof .fa-chevron-down").click(function(){   
                    $('html,body').animate({
